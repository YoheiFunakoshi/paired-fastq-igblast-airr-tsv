...
class PairSummaryTests(unittest.TestCase):
    ...
    def test_split_and_integrate_keeps_conflicts_with_simple_rule(self) -> None:
        ...
        try:
            ...
            input_tsv.write_text(
                "\n".join(
                    [
                        ...
                        "readA_dup|R1\tIGHV1\tIGHD1\tIGHJ4\tAAATTT\tCAR\tT",
                        "readA_dup|R2\tIGHV1\tIGHD1\tIGHJ4\tAAATTT\tCAR\tT",
            ...
            self.assertEqual(stats.unique_final_clonotypes, 3)
            ...
            self.assertEqual(count_rows[0]["usable_for_qasas_count"], "2")
        finally:
            shutil.rmtree(root, ignore_errors=True)
